          ...
          <div class="parameters-grid">
            ...
            <div class="form-row">
              ...
              <input
                ...
                min="0"
                required
                @input="validaRaggioPiega"
              />
              <p v-if="errors.raggioPiega" class="error-message">
                Il raggio di piega non può essere negativo.
              </p>
            </div>
          ...
          <div v-for="(segment, index) in segments" :key="index" class="segmento">
            <div class="segment-grid">
              <div class="form-row">
                ...
                />
                <p v-if="segment.errorLength" class="error-message">
                  La lunghezza deve essere maggiore di 0.
                </p>
              </div>
              ...
              <div class="form-row">
                ...
                <input
                  ...
                  required
                />
                <p v-if="segment.errorAngle" class="error-message">
                  Angolo non valido! Deve essere tra -180° e 180°.
                </p>
              </div>
      ...
      <div v-show="activeTab === 'results'" class="tab-content">
        ...
        <section class="export-section">
          ...
          <div class="export-buttons">
            <button @click="esportaPDF" class="btn-export"><span class="icon">📄</span> PDF</button>
            <button @click="esportaDXF" class="btn-export"><span class="icon">📐</span> DXF</button>
            <button @click="esportaSVG" class="btn-export"><span class="icon">🖋️</span> SVG</button>
          </div>
        </section>
      </div>
            ...
            <div class="result-card-group">
              <div class="result-card">
                ...
                <div class="result-value">
                  {{ risultatiAvanzati.forzaPiega.forzaTon.toFixed(2) }} t
                </div>
                <div class="result-note">
                  {{ risultatiAvanzati.forzaPiega.forzaKN.toFixed(2) }} kN
                </div>
              </div>
              ...
              <div class="result-card">
                ...
                <div class="result-value">
                  {{ risultatiAvanzati.aperturaMatrice.aperturaOttimale.toFixed(2) }} mm
                </div>
                <div class="result-note">
                  Range: {{ risultatiAvanzati.aperturaMatrice.rangeConsigliato.min.toFixed(2) }} -
                  {{ risultatiAvanzati.aperturaMatrice.rangeConsigliato.max.toFixed(2) }} mm
                </div>
              </div>
...
export default {
  ...
  computed: {
    fattoreKEffettivo() {
      if (this.fattoreKDinamico) {
        ...
        const rapporto =
          this.spessore > 0 && this.raggioPiega > 0 ? this.raggioPiega / this.spessore : 0;
  ...
  watch: {
    ...
    spessore() {
      ...
      this.larghezzaMatrice = 8 * this.spessore;
  ...
  methods: {
    ...
    esportaPDF() {
      ...
      doc.text(
        `Lunghezza totale di taglio: ${this.risultato.toFixed(2)} mm`,
        10,
        120 + this.segments.length * 10
      );
