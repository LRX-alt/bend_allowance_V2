 ...
 */
export function calcolaBendAllowanceAvanzato(angolo, spessore, raggioPiega, metodo, fattoreK = 0.33) {
  // Angolo in radianti
...
export function calcoliAvanzatiPiegatura(params) {
  ...
  const raggioMinimo = calcolaRaggioMinimo(
    materiale, 
    spessore, 
    direzione
  );
  ...
  const aperturaMatrice = calcolaAperturaMatrice(
    spessore, 
    processo, 
    materiale
  );
